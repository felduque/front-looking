      ...
      .then(function (response) {
        ...
        if (response.data) {
          if (response.data.status === "approved") {
            axios.patch("https://looking.fly.dev/tenant/updatePro", {
              id: tenantId,
              pro: true,
            });

            axios.post("https://looking.fly.dev/sendEmail/pay", {
              fullName: nameTenant,
              email: auth.email,
              priceTotal: 8.99,
            ...
            axios(`https://looking.fly.dev/tenant/gettenant/${tenantId}`).then(
              (res) => {
                if (res.data?.Properties.length > 0) {
                  res.data.Properties.forEach((e) => {
                    axios.patch("https://looking.fly.dev/property/update/pro", {
                      id: e.id,
                    });
                  });
                }
            ...
            // axios
            //   .get(`https://looking.fly.dev/client/getuser/${clientId}`)
            //   .then((res) => {
            ...
            // axios
            //   .patch("https://looking.fly.dev/property/update/bookings", {
            //     id: idProperty,
            //     bookings,
            //     idClient: clientId,
            //   })
            ...
            // axios(`https://looking.fly.dev/property/${parseInt(idProperty)}`)
            //   .then((res) => {
            ...
            //   .then((prop) => {
            //     axios
            //       .post("https://looking.fly.dev/createBooking", {
            ...
            //     axios
            //       .post("https://looking.fly.dev/pay/payment", {
            ...
            // axios.post("https://looking.fly.dev/pay/payment", {
            //   description: titlePay,
            //   amount: priceTotal,
            //   status: "Aprobado",
            //   type: metodoPago, // METODO DE PAGO -> QUE TARJETA
